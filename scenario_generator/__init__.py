"""Agentic scenario generator: intake -> benchmark scenarios -> coverage mapping.

Public surface for programmatic use:

    from scenario_generator import build_graph, build_probes_stage, refine, \
        assess_materiality, review, map_coverage, generate
    from scenario_generator.core import IntakeData, Scenario
    from scenario_generator.llm import ScenarioWriter, MaterialityAssessor, \
        ScenarioReviewer, MetadataExtractor

The submodules `core`, `llm`, `io` and `utils` are also importable directly.
"""
from .llm import (MaterialityAssessor, MetadataExtractor, NullMaterialityAssessor, NullReviewer,
                  NullWriter, ScenarioReviewer, ScenarioWriter)
from .pipeline import (assess_materiality, build_graph, build_pack, build_probes_stage,
                       build_scenarios, generate, map_coverage, refine, review)
...
__all__ = [
    ...
    "build_pack",
    "generate", "map_coverage", "build_scenarios",
