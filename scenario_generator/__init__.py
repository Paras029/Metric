"""Agentic scenario generator: intake -> scenarios in the space -> coverage of existing testing.
...
from .pipeline import (assess_materiality, build_graph, build_pack, build_probes_stage,
                       build_scenario_space, generate, map_conversation_coverage, refine, review)
