...
def _environment() -> Environment:
    return Environment(loader=FileSystemLoader(str(HERE / "templates")),
...
def render_graph_page(intake: IntakeData, scenarios: Optional[Sequence[Scenario]] = None,
    ...
    return _environment().get_template(TEMPLATE).render(
        ...
        stylesheet=(HERE / "static" / "app.css").read_text(encoding="utf-8"),
        script=(HERE / "static" / "graph.js").read_text(encoding="utf-8"))
