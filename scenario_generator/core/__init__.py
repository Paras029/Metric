"""Domain logic: intake parsing, the decision graph, scenario generation, probe selection,
proposal validation and coverage matching.

No file I/O beyond the intake workbook itself, and no model calls.
"""
from .context import load_context
from .coverage import coverage_gaps, coverage_summary, incremental_owner, match_scenarios
...
from .models import (CAPABILITY_TYPES, FUNCTIONAL_ORIGINS, BenchmarkScenario, Capability, Decision, ExtractedMeta, IntakeData, Match,
                     OwnerScenario, Persona, Scenario, State, Step, Tool, TurnMeta)

__all__ = [
    "IntakeData", "Persona", "Capability", "Decision", "State", "Tool",
    "Scenario", "Step", "TurnMeta", "BenchmarkScenario", "OwnerScenario", "ExtractedMeta", "Match",
    ...
    "recommended_turns", "required_runs", "turn_plan_lines",
    "match_scenarios", "coverage_gaps", "incremental_owner", "coverage_summary",
