...
from metric.domain.models import CATEGORIES, INPUT_SOURCES
from metric.shared.replies import at_least_one, objects as _objects, string_list as _list, text as _text
from metric.shared.text import ID_BODY, one_of
