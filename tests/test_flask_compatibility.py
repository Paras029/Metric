...
class TestEveryRouteIsReachable(unittest.TestCase):
    ...
    def test_the_expected_routes_exist_with_the_expected_methods(self):
        ...
        expected = {
            ...
            "/stage/<key>/carry-forward": ["POST"],
            "/stage/intake/capability/<capability_id>/span": ["POST"],
            "/stage/intake/declaration": ["GET"],
            "/stage/intake/declaration/preview": ["POST"],
            "/stage/intake/declaration/save": ["POST"],
            "/stage/intake/declaration/row": ["POST"],
